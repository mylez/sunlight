...
func (c *Congress) GetLegislators(criteria map[string]string) (*LegislatorResult, error) {
	l := LegislatorResult{}
	err := c.GetURL(&l, congressRoot, criteria, "legislators")
	if err != nil {
		return nil, err
	}
	return &l, nil
...
func (c *Congress) GetLegislatorsByLatLon(lat string, lon string, params map[string]string) (*LegislatorResult, error) {
	...
	l := LegislatorResult{}
	err := c.GetURL(&l, congressRoot, params, "legislators", "locate")
	if err != nil {
		return nil, err
	}
	return &l, nil
