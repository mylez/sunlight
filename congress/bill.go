...
func (c *Congress) BillSearch(criteria map[string]string) (*BillResult, error) {
	l := BillResult{}
	err := c.GetURL(&l, congressRoot, criteria, "bills")
	if err != nil {
		return nil, err
	}
	return &l, nil
...
func (c *Congress) BillTextSearch(query string, criteria map[string]string) (*BillResult, error) {
	criteria["query"] = query
	l := BillResult{}
	err := c.GetURL(&l, congressRoot, criteria, "bills", "search")
	if err != nil {
		return nil, err
	}
	return &l, nil
